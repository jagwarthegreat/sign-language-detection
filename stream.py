...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        # Show to screen
        # cv2.namedWindow("Sign Language Detection using CNN Algorithmn",cv2.WND_PROP_FULLSCREEN)
        # cv2.setWindowProperty("Sign Language Detection using CNN Algorithmn",cv2.WND_PROP_FULLSCREEN,cv2.WINDOW_FULLSCREEN)
